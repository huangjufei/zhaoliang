...
public class UserFactory {
    ...
    public static User editUser(UserDto newUser, User oldUser) {
        if (newUser == null || oldUser == null) {
            ...
            if (ToolUtil.isNotEmpty(newUser.getQq())) {
                oldUser.setQq(newUser.getQq());
            }
            if (ToolUtil.isNotEmpty(newUser.getWeixin())) {
                oldUser.setWeixin(newUser.getWeixin());
            }
            if (ToolUtil.isNotEmpty(newUser.getCompany())) {
