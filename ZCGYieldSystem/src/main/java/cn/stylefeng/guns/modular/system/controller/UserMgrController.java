...
public class UserMgrController extends BaseController {
    ...
    public String userEdit(@RequestParam Long userId ,String company) {
        if (ToolUtil.isEmpty(userId)) {
            throw new ServiceException(BizExceptionEnum.REQUEST_NULL);
        }
    ...
    public Object list(@RequestParam(required = false) String name,
        ...
        if (ShiroKit.isAdmin()) {
        	...
        	List<User> userList = jpaUserRepository.findAllByConditions(allRoleList ,name == null ? null : "%" + name + "%"
        			,deptId ,"".equals(beginTime) ? null : beginTime ,"".equals(endTime) ? null : endTime ,userId);
